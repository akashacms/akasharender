...
This element integrates with the [Highlight.js library](https://www.npmjs.com/package/highlight.js) and therefore the `lang` codes must be from their list of supported programming languages.
